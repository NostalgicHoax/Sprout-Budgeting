...
function SummaryPanel({ state, month, refresh, onCollapse }) {
  ...
  return (
    <aside className="right-panel">
      ...
      <div className="summary-row bold"><span>Available</span><span>{fmt(summary.available)}</span></div>

      <div className="divider" />

      <div className="panel-title">⚡ Auto-Assign</div>
      <div className="auto-list">
        ...
        <div className="auto-item static">
          <span>Spent Last Month</span><span>{fmt(summary.prevSpentTotal)}</span>
        </div>
        <div className="auto-item static">
          <span>Income This Month</span><span>{fmt(state.incomeThisMonth)}</span>
        </div>
      </div>
